...
class LoginModel
{
    ...
    {/*
        ...
        if (!$this->checkCaptcha()) {
            ...
            $_SESSION["feedback_negative"][] = FEEDBACK_CITY_FIELD_EMPTY;
        ...
        elseif (!empty($_POST['user_name'])
            ...
            $sql = "INSERT INTO users (user_name, user_city,user_password_hash, user_email, user_account_type,user_creation_timestamp, user_activation_hash, user_provider_type)
                    VALUES (:user_name, :user_city,:user_password_hash, :user_email, :user_account_type,:user_creation_timestamp, :user_activation_hash, :user_provider_type)";
