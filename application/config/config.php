 ...
 */
define('URL', 'http://localhost/elbuenpastor/');
 ...
 */
define("FEEDBACK_UNKNOWN_ERROR", "Un error ha ocurrido!");
define("FEEDBACK_PASSWORD_WRONG_3_TIMES", "Tienes ingresado incorrectamente tu contraseña 3 o más veces. Por favor espere 30 segundos e intente de nuevo.");
define("FEEDBACK_ACCOUNT_NOT_ACTIVATED_YET", "Your account is not activated yet. Please click on the confirm link in the mail.");
define("FEEDBACK_PASSWORD_WRONG", "Contraseña incorrecta.");
define("FEEDBACK_USER_DOES_NOT_EXIST", "El usuario no existe.");
// The "login failed"-message is a security improved feedback that doesn't show a potential attacker if the user exists or not
define("FEEDBACK_LOGIN_FAILED", "Error de inicio de sesión.");
define("FEEDBACK_USERNAME_FIELD_EMPTY", "Ingrese nombre usuario.");
define("FEEDBACK_CITY_FIELD_EMPTY", "Ingrese ciudad usuario.");
define("FEEDBACK_TYPE_FIELD_EMPTY", "Ingrese nombre usuario.");
define("FEEDBACK_PASSWORD_FIELD_EMPTY", "Ingrese su contraseña.");
define("FEEDBACK_EMAIL_FIELD_EMPTY", "Los campos email y contraseña estan vacíos.");
define("FEEDBACK_EMAIL_AND_PASSWORD_FIELDS_EMPTY", "El campo correo está vacíos.");
define("FEEDBACK_USERNAME_SAME_AS_OLD_ONE", "Lo sentimos, that username is the same as your current one. Please choose another one.");
...
define("FEEDBACK_PASTOR_CREATION_FAILED", "Error al agregar nuevo pastor.");
define("FEEDBACK_NOTE_EDITING_FAILED", "Note editing failed.");
define("FEEDBACK_PASTOR_EDITING_FAILED", "Error en la edición del pastor.");
define("FEEDBACK_NOTE_DELETION_FAILED", "Note deletion failed.");
define("FEEDBACK_PASTOR_DELETION_FAILED", "Error al eliminar pastor.");
