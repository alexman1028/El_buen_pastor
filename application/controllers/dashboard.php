...
class Dashboard extends Controller
{
    ...
    {
        $note_model = $this->loadModel('Dashboard');
    ...
    public function create()
    {
        ...
        if (isset($_POST['nombre_joven']) AND !empty($_POST['nombre_joven']) AND isset($_POST['apellido']) AND !empty($_POST['apellido'] )) {
            $note_model = $this->loadModel('Dashboard');
            $note_model->create($_POST['nombre_joven'],$_POST['apellido'],$_POST['sexoper'],$_POST['edad'],$_POST['email'],$_POST['auto'],$_POST['encargado'],$_POST['iglesia'],$_POST['ciudad'],$_POST['telefono'],$_POST['familia']);
        }
